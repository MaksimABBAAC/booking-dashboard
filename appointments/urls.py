...
from .views import AppointmentDeleteView, AppointmentUpdateView, AvailableAppointmentsList, BookAppointmentView, BookingView

app_name = "appointments"

urlpatterns = [
    path('book/<int:master_id>/', BookingView.as_view(), name='booking'),
    path('available/', AvailableAppointmentsList.as_view(), name='available-appointments'),
